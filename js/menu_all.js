...
Menu1=new Array("Sharon Hall","index.php","",4,20,240);
  Menu1_1=new Array("Biography","sh_000.php","",0,20,240);
  Menu1_2=new Array("All","sh_013.php","",0,20,0);
  Menu1_3=new Array("Selected","sh_014.php","",0,20,240);
  Menu1_4=new Array("Omitted","sh_015.php","",0,20,240);

Menu2=new Array("Paintings","index.php","",12,20,240);
  Menu2_1=new Array("Banners","sh_001.php","",0,20,240);
  Menu2_2=new Array("Catalogues and Primers","sh_002.php","",0,20,240);
  Menu2_3=new Array("Greyfriars","sh_003.php","",0,20,240);
  Menu2_4=new Array("Roma","sh_004.php","",0,20,240);
  Menu2_5=new Array("Thomas Bewick and other Allegories","sh_005.php","",0,20,240);
  Menu2_6=new Array("Printed Paintings","sh_006.php","",0,20,240);
  Menu2_7=new Array("Gold Dust Pieces","sh_007.php","",0,20,240);
  Menu2_8=new Array("Ornament","sh_008.php","",0,20,240);
  Menu2_9=new Array("Starmaps and Follies","sh_009.php","",0,20,240);
  Menu2_10=new Array("The World Turned Upside Down","sh_010.php","",0,20,240);
  Menu2_11=new Array("Histories","sh_011.php","",0,20,240);
  Menu2_12=new Array("Current Work","sh_012.php","",5,20,0);
   Menu2_12_1=new Array("1999-2003","sh_016.php","",0,20,240);
   Menu2_12_2=new Array("2003-2005","sh_017.php","",0,20,0);
   Menu2_12_3=new Array("Surface/Connections","sh_018.php","",0,20,80);
   Menu2_12_4=new Array("New Work 2005","sh_019.php","",0,20,80);
   Menu2_12_5=new Array("Islington Mill Gallery 2005","sh_020.php","",0,20,80);
